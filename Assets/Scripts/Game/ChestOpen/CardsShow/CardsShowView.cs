...
namespace ChestGame.Game.View
{
    public class CardsShowView : MonoBehaviour, IView
    {
        ...
        [SerializeField] internal GameObject WimAnimationParticles;
        [SerializeField] internal AudioSource LoseCombinationSound;
        [SerializeField] internal AudioSource BonusCombinationSound;
